...
//abstract class StreamNotConsumedCheck {
//
//  void test() {
...
//      Stream.of(0, 3).filter(i -> true), // Compliant, passed outside of method
//      Stream.of(2));
//  }
//
...
class B {
  Number product(Stream<Number> s, Object o) {
    try {
      return s
        .mapToDouble(Number::doubleValue)
        .reduce(((Number) o).doubleValue(), (d1, d2) -> d1 * d2);
